...
Function Grant-OAuth2PermissionsToApp {
    ...
    foreach ($requiredResourceAccess in $azureADAppClient.RequiredResourceAccess) {
        ...
        foreach ($resourceAccess in $RequiredResourceAccess.ResourceAccess) {
            ...
            # Set scope variable by searching Azure AD apps resource access scope ID's in $oauth2ServicePrincipal oauth2Permissions ID's and adding to scop variable 
        ...
        # Set appRoleIdScopeArray variable by searching Azure AD apps resource access scope ID's in $oauth2ServicePrincipal appRoles object and adding to appRoleIdScopeArray variable 
